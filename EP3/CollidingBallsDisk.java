 ...
 * Data: 03/11/2024
 *
 * Baseado em CollidingBallsDeLuxe.java, exercícios em sala, monitoria e Sandbox das aulas.
 *
...
public class CollidingBallsDisk {
        ...
        while (true) {
            ...
            for (int i = 0; i < N; i++) {
                ...
                if (dist + RADIUS > circleRadius) {
                    // vetor normal no ponto de contato
                    double nx = dx / dist;
                    double ny = dy / dist;
